...
def return_videos_df(channel_id,playlist_id,is_video_int):
    videos_col_list=['video_id','playlist_id','video_url','thumb_img','video_title','video_views','date']
    clear_videos_df(videos_col_list)
    making_youtube_table(channel_id,playlist_id,is_video_int)
...
def making_youtube_table(channel_id,playlist_id,is_video_int):
    videos_col_list=['video_id','playlist_id','video_url','thumb_img','video_title','video_views','date']
